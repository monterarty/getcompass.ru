...
`;
  ...
  window.addEventListener("load", () => {
    ...
    const startDownload = getCookie(`startDownload_${downloadPlatform}`) !== "no" || mobileClassNames.includes(downloadPlatform) && (os === "iOS" && downloadPlatform == "appstore" || os === "Android" && ["playmarket", "huawei", "rustore"].includes(downloadPlatform));
