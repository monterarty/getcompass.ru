...
`;
  ...
  window.addEventListener("load", () => {
    ...
    const startDownload = getCookie(`startDownload_${downloadPlatform}`) !== "no" || os === "iOS" && downloadPlatform === "appstore" || os === "Android" && ["playmarket", "huawei", "rustore"].includes(downloadPlatform);
