...
const downloadLinksData = {
  ...
  cloudPage: [
    ...
    "https://appgallery.huawei.com/?agc_click_id=465812443111623680#/app/C109414583",
    "",
    '<path d="M15.5448 15.9467H6.84363C4.68256 15.9467 3.05859 14.3859 3.05859 12.5281C3.05859 10.9863 3.94956 9.70987 5.37764 9.48239C5.40924 7.71309 7.10271 6.53145 8.65717 6.98641C9.41544 5.8806 10.635 4.96436 12.3474 4.96436C14.9319 4.96436 16.9602 6.99905 16.9476 9.8173C18.1798 10.3354 18.9444 11.4855 18.9444 12.8125C18.9444 14.5502 17.4531 15.9467 15.5448 15.9467Z" fill="currentColor"/>'
  ],
  onpremisePage: [
    "Приложение для ",
    "on-premise версии",
    ...
    "https://appgallery.huawei.com/?agc_click_id=465812443111623680#/app/C109414583",
    "",
    '<path d="M6.22886 11.3061C5.63488 11.3061 5.09145 11.4388 4.61753 11.6789L6.13408 8.03289C6.52585 7.07873 7.35363 6.56689 8.44681 6.56689H13.5462C14.6394 6.56689 15.4671 7.07873 15.8589 8.03289L17.3691 11.6789C16.9015 11.4388 16.3581 11.3061 15.7641 11.3061H6.22886ZM6.22886 17.1448C4.75023 17.1448 3.72656 16.1274 3.72656 14.6614C3.72656 13.1955 4.75023 12.1718 6.22886 12.1718H15.7641C17.2428 12.1718 18.2664 13.1955 18.2664 14.6614C18.2664 16.1274 17.2428 17.1448 15.7641 17.1448H6.22886ZM14.8479 14.6741C14.8479 15.1291 15.227 15.4829 15.6693 15.4829C16.1054 15.4766 16.4782 15.1227 16.4782 14.6741C16.4782 14.2381 16.1054 13.8589 15.6693 13.8589C15.227 13.8589 14.8479 14.2381 14.8479 14.6741Z" fill="currentColor"/>',
  ]
}
...
const downloadLinksOtherLinkWrap = `
    <div class="cta__dd-list-other-wrap">
      <a href="/download" class="cta__list-item cta__list-other-button cursor-pointer w-inline-block">
...
downloadLinksOtherLink.addEventListener('click', () => {
  if ((getPage() === 'home') || downloadLinksOtherLink.closest('.nav').length > 0) {
