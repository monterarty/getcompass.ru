(function($2) {
  ...
  function getRuleIndex(rule) {
    ...
    var _a2 = rule.name.split("/"), group = _a2[1];
  ...
  function prepareRule(rule) {
    var _a2 = rule.name.split("/"), locale = _a2[0], group = _a2[1], shortName = _a2[2];
    var preparedRule = {
      name: rule.name,
      shortName,
  ...
  var Typograf = (
    ...
    function() {
      ...
      Typograf2.prototype.splitBySeparateParts = function(context) {
        ...
        var position = 0;
        context.text.replace(reTags, function($0, $1, $22, itemPosition) {
  ...
  function replaceNbsp($0, $1, $22, $3) {
    return $1 + $22.replace(/([^\u00A0])\u00A0([^\u00A0])/g, "$1 $2") + $3;
  }
  var nowrapRule = {
  ...
  var digitGroupingRule = {
    ...
    handler: function(text, settings2) {
      return text.replace(new RegExp("(^ ?|\\D |".concat(privateLabel, ")(\\d{1,3}([    ]\\d{3})+)(?! ?[\\d-])"), "gm"), function($0, $1, $22) {
        return $1 + $22.replace(/\s/g, settings2.space);
  ...
  var Quote = (
    ...
    function() {
      ...
      Quote2.prototype.set = function(text, params) {
        ...
        text = text.replace(reL, function($0, $1, $22) {
          return $1 + repeat(lquote, $22.length);
        }).replace(reR, function($0, $1, $22) {
          return $1 + repeat(rquote, $22.length);
        });
  ...
  var afterCommaRule = {
    ...
    handler: function(text, settings2, context) {
      ...
      return text.replace(new RegExp('(.),([^)",:.?\\s\\/\\\\' + privateLabel + quotes + "])", "g"), function($0, $1, $22) {
        return isDigit($1) && isDigit($22) ? $0 : $1 + ", " + $22;
      });
    }
  };
  ...
  var toRule = {
    ...
    handler: function(text) {
      ...
      return text.replace(re, function($0, $1, $22, $3, $4) {
        var kakto = $22 + $3 + $4;
  ...
  var yearsRule$1 = {
    ...
    handler: function(text, settings2) {
      ...
      return text.replace(re, function($0, $1, $22, $3, $4) {
        if (parseInt($22, 10) < parseInt($4, 10)) {
          return $1 + $22 + settings2.dash + $4;
        }
        return $0;
      });
    },
  ...
  var weekdayRule = {
    ...
    handler: function(text) {
      ...
      return text.replace(re, function(_, $1, $22, $3, $4, $5) {
        return $1 + $22 + $3.toLowerCase() + "," + $4 + $5.toLowerCase();
      });
    }
  };
  Typograf.addRules([
  ...
  var currencyRule = {
    ...
    handler: function(text) {
      ...
      return text.replace(re12, function($0, $1, $22, $3, $4, $5, $6, $7) {
        return $1 + $3 + ($7 ? " " + $7 : "") + " " + $22;
      }).replace(re22, "$1$2 $4");
    },
    disabled: true
  ...
  var mRule = {
    ...
    handler: function(text) {
      ...
      return text.replace(re, function(_$0, $1, $22, $3, $4, $5) {
        return $1 + $22 + " " + $3 + pow[$4 || ""] + ($5 === " " ? " " : $5);
      });
    }
  };
  var mlnRule = {
  ...
  var psRule = {
    ...
    handler: function(text) {
      ...
      return text.replace(re, function($0, $1, $22) {
        return $1 + ($22 ? "P. P. S. " : "P. S. ");
      });
    }
  };
  var rubleKopekRule = {
  ...
  var accentRule = {
    ...
    handler: function(text) {
      return text.replace(/([а-яё])([АЕЁИОУЫЭЮЯ])([^А-ЯЁ\w]|$)/g, function($0, $1, $22, $3) {
        return $1 + $22.toLowerCase() + "́" + $3;
      });
    },
    disabled: true
  };
  ...
  function scope(target, options, originalOptions) {
    ...
    function addMarking(spread, filterFunc, formatter) {
      ...
      var markerSizeClasses = (_b2 = {}, _b2[PipsType.None] = "", _b2[PipsType.NoValue] = options.cssClasses.markerNormal, _b2[PipsType.LargeValue] = options.cssClasses.markerLarge, _b2[PipsType.SmallValue] = options.cssClasses.markerSub, _b2);
  ...
  (() => {
	...
	data: ${i}`);
      ...
      async emit(e, t) {
        ...
        let n = (a = $3(this, e)) != null ? a : /* @__PURE__ */ new Set(), r = v.get(this), s = [...n], i = F(e) ? [] : [...r];
      ...
      async emitSerial(e, t) {
        ...
        let n = (a = $3(this, e)) != null ? a : /* @__PURE__ */ new Set(), r = v.get(this), s = [...n], i = [...r];
        await Le;
      ...
      listenerCount(e) {
        ...
        for (let l of e) {
          if (typeof l == "string") {
            t += v.get(this).size + ((r = (n = $3(this, l)) == null ? void 0 : n.size) != null ? r : 0) + ((i = (s = H(this, l)) == null ? void 0 : s.size) != null ? i : 0) + ((c = (a = H(this)) == null ? void 0 : a.size) != null ? c : 0);
            continue;
          }
    ...
    var z = class {
      constructor() {
        ...
        switch (this.mode = w(t, _e2) ? t : "opt-in", this.mode) {
          case "informational":
          case "opt-out":
            this.consents = { ...q };
            break;
  ...
  (function(exports) {
    !function(root, factory) {
      ...
      function getScrollbarWidth() {
        if ($3(document).height() <= $3(window).height()) {
          return 0;
        }
      ...
      function syncWithAnimation(doBeforeAnimation, doAfterAnimation, instance) {
        ...
        var handleAnimationEnd = function(e) {
          ...
          if (--runningAnimationsCount === 0) {
            $3.each(["$bg", "$overlay", "$wrapper", "$modal"], function(index, elemName) {
      ...
      function handleHashChangeEvent() {
        ...
        if (!id) {
          ...
          if ($elem && $elem.length) {
            instance = $3[PLUGIN_NAME].lookup[$elem.data(PLUGIN_NAME)];
      ...
      function Remodal($modal, options) {
        var $body = $3(document.body);
        var $appendTo = $body;
        var remodal = this;
        remodal.settings = $3.extend({}, DEFAULTS, options);
        remodal.index = $3[PLUGIN_NAME].lookup.push(remodal) - 1;
        remodal.state = STATES.CLOSED;
        remodal.$overlay = $3("." + namespacify("overlay"));
        if (remodal.settings.appendTo !== null && remodal.settings.appendTo.length) {
          $appendTo = $3(remodal.settings.appendTo);
        }
        if (!remodal.$overlay.length) {
          remodal.$overlay = $3("<div>").addClass(namespacify("overlay") + " " + namespacify("is", STATES.CLOSED)).hide();
          $appendTo.append(remodal.$overlay);
        }
        remodal.$bg = $3("." + namespacify("bg")).addClass(namespacify("is", STATES.CLOSED));
        remodal.$modal = $modal.addClass(
          NAMESPACE + " " + namespacify("is-initialized") + " " + remodal.settings.modifier + " " + namespacify("is", STATES.CLOSED)
        ).attr("tabindex", "-1");
        remodal.$wrapper = $3("<div>").addClass(
      ...
      Remodal.prototype.destroy = function() {
        var lookup = $3[PLUGIN_NAME].lookup;
        var instanceCount;
        halt(this);
        this.$wrapper.remove();
        delete lookup[this.index];
        instanceCount = $3.grep(lookup, function(instance) {
          return !!instance;
        }).length;
        if (instanceCount === 0) {
          this.$overlay.remove();
      ...
      $3.fn[PLUGIN_NAME] = function(opts) {
        var instance;
        var $elem;
      ...
      $3(document).ready(function() {
        $3(document).on("click", "[data-" + PLUGIN_NAME + "-target]", function(e) {
          e.preventDefault();
          var elem = e.currentTarget;
          var id = elem.getAttribute("data-" + PLUGIN_NAME + "-target");
          var $target = $3("[data-" + PLUGIN_NAME + '-id="' + id + '"]');
          $3[PLUGIN_NAME].lookup[$target.data(PLUGIN_NAME)].open();
        });
        $3(document).find("." + NAMESPACE).each(function(i, container) {
        ...
        $3(document).on("keydown." + NAMESPACE, function(e) {
          if (current && current.settings.closeOnEscape && current.state === STATES.OPENED && e.keyCode === 27) {
            current.close();
          }
        });
        $3(window).on("hashchange." + NAMESPACE, handleHashChangeEvent);
      });
    });
  })();
  ...
  class DeviceDetect {
    ...
    static get0S() {
      var _a2;
      return (_a2 = DeviceDetectParser.getOS()) == null ? void 0 : _a2.name.toLowerCase();
    }
    static isMacOs() {
      var _a2;
      return !DeviceDetect.isMobile() && ((_a2 = DeviceDetect.get0S()) == null ? void 0 : _a2.includes("mac os"));
    }
    static isWindows() {
      var _a2;
      return !DeviceDetect.isMobile() && ((_a2 = DeviceDetect.get0S()) == null ? void 0 : _a2.includes("window"));
    }
    static isLinux() {
    ...
    static isIPad() {
      var _a2, _b2;
      return (_b2 = (_a2 = DeviceDetectParser.getDevice()) == null ? void 0 : _a2.model) == null ? void 0 : _b2.includes("iPad");
    }
  }
  class Attribution {
  ...
  function getUtmParams() {
    ...
    return {
      utm_source: urlParams2.get("utm_source") || "",
      utm_medium: urlParams2.get("utm_medium") || "",
      utm_campaign: urlParams2.get("utm_campaign") || "",
      utm_term: urlParams2.get("utm_term") || "",
      utm_content: urlParams2.get("utm_content") || ""
    };
  }
  const clickEventsItems = document.querySelectorAll("[data-click-event]");
  clickEventsItems == null ? void 0 : clickEventsItems.forEach((item) => {
  ...
  Detector.detect();
  switch (platform == null ? void 0 : platform.name) {
    case "Safari":
      switch ((_a = platform == null ? void 0 : platform.os) == null ? void 0 : _a.family) {
        case "iOS":
          if (((_b = platform == null ? void 0 : platform.version) == null ? void 0 : _b.split(".")[0]) <= 13 && ((_d = (_c = platform == null ? void 0 : platform.os) == null ? void 0 : _c.version) == null ? void 0 : _d.split(".")[0]) <= 13) {
            showOldBrowserMsg();
          }
          break;
        case "OS X":
          if (((_e = platform == null ? void 0 : platform.version) == null ? void 0 : _e.split(".")[0]) <= 13) {
            showOldBrowserMsg();
          }
      ...
      break;
    case "Chrome":
      if (((_f = platform == null ? void 0 : platform.version) == null ? void 0 : _f.split(".")[0]) <= 87) {
        showOldBrowserMsg();
      }
      break;
    case "Chrome Mobile":
      if (((_g = platform == null ? void 0 : platform.version) == null ? void 0 : _g.split(".")[0]) <= 87) {
        showOldBrowserMsg();
      }
      break;
    case "Opera":
      if (((_h = platform == null ? void 0 : platform.version) == null ? void 0 : _h.split(".")[0]) <= 73) {
        showOldBrowserMsg();
      }
      break;
    case "Firefox":
      if (((_i = platform == null ? void 0 : platform.version) == null ? void 0 : _i.split(".")[0]) <= 73) {
        showOldBrowserMsg();
      }
      break;
  }
  $2(document).ready(function() {
    $2(".w-webflow-badge").removeClass("w-webflow-badge").empty();
  });
  function getOS() {
    let userAgent = window.navigator.userAgent, platform2 = window.navigator.userAgentData ? window.navigator.userAgentData : window.navigator.platform || window.navigator.platform, macosPlatforms = ["Macintosh", "MacIntel", "MacPPC", "Mac68K", "macOS"], windowsPlatforms = ["Win32", "Win64", "Windows", "WinCE"], iosPlatforms = ["iPhone", "iPad", "iPod"], os2 = null;
  ...
  let os = (_j = platform == null ? void 0 : platform.os) == null ? void 0 : _j.family;
  ...
  function isTouchDevice() {
    return "ontouchstart" in window || navigator.maxTouchPoints > 0 || (navigator == null ? void 0 : navigator.msMaxTouchPoints) > 0;
  }
  if (isTouchDevice()) {
...
`;
    ...
    mutations.forEach((mu) => {
      if (mu.type === "attributes" && mu.attributeName === "class") {
        ...
        if (isOpen) {
          ...
          const isBottomEmptySpace = bottom + offset2 >= viewportHeight;
  ...
  allDownloadDropdowns.forEach((downloadDropdown) => {
    ...
    toggle.addEventListener("mousedown", (e) => {
      ...
      if (isOpen) {
        ...
        Array.prototype.forEach.call(allDownloadLinks, (link) => {
          if (!mobileDownloadPlatformsNames.some(
            (className) => link.classList.contains(className)
          ) && !isMobileDevice) ;
          else if (!mobileDownloadPlatformsNames.some(
            (className) => link.classList.contains(className)
          ) && isMobileDevice) {
  ...
  window.addEventListener("load", () => {
    ...
    const isAndroidDownload = os === "Android" && ["playmarket", "huawei", "rustore"].includes(downloadPlatform);
    const isStartDownloadFromCookie = getCookie(`startDownload_${downloadPlatform}`) !== "no";
    const isDesktopDownloadPlatform = !mobileDownloadPlatformsNames.includes(downloadPlatform);
    const isStartDownload = (isStartDownloadFromCookie || isAndroidDownload || isIosDownload) && !(isMobileDevice && isDesktopDownloadPlatform);
  ...
  Array.prototype.forEach.call(downloadLinks, (downloadLink) => {
    ...
    const isLinkForMobilePlatform = mobileDownloadPlatformsNames.includes(platform2);
    if (!downloadLink.dataset.version && platform2) {
      ...
      if (!isLinkForMobilePlatform && isMobileDevice) {
        if (isShowOnpremiseLinks) {
          downloadLink.setAttribute("build-link", downloadLinksData[platform2][4]);
        } else {
          downloadLink.setAttribute(
            "build-link",
            window.location.origin + instructionLinks[platform2]
          );
        }
        downloadLink.href = "#";
      }
    ...
    downloadLink.addEventListener("click", (e) => {
      ...
      const blockID = ((_b2 = (_a2 = downloadLink.closest("[data-block]")) == null ? void 0 : _a2.dataset) == null ? void 0 : _b2.block) ?? "";
      console.log(blockID);
      const isInstructionLinkPresent = window.location.href.includes(
        instructionLinks[platform2]
      );
      const isSaasPlatformsBlock = downloadLink.closest(".download_cloud-block") !== null;
      const isOnPremisePlatformsBlock = downloadLink.closest(".download_op-block") !== null;
      const isDonwloadHeroBlock = downloadLink.closest(".is--download-ddown") !== null;
      if (downloadLink.dataset.version === "cloud") {
        ...
        } else if (isInstructionLinkPresent && (isMobileDevice && isLinkForMobilePlatform || !isMobileDevice)) {
  ...
  function addInputPhoneMask() {
    ...
    const onPasteHandler = async (event) => {
      ...
      let pastedText = "";
      if ((_a2 = event.clipboardData) == null ? void 0 : _a2.getData) {
  ...
  function removeErrorClassOnInput(input) {
    ...
    input.onblur = function() {
      ...
      if (os === "iOS" && parseFloat(platform == null ? void 0 : platform.version.replace(/\D/g, "")) > 1731) {
  ...
  if (getPage() === "partner") {
    ...
    const switchCalcInfoTab = () => {
      ...
      $2(`[data-w-tab="${tarif}"]`).trigger("click");
    };
    Array.prototype.forEach.call(calcTarifsRadio, (radio) => {
  ...
  Typograf.addRule({
    name: "common/other/onPremiseInlineBlock",
  ...
  faqContentListItems == null ? void 0 : faqContentListItems.forEach((item) => {
  ...
  window.fsAttributes.push([
    "cmsload",
    (listInstances) => {
      if ($2(".fs-cms_pagination-wrapper").length) {
        $2(".fs-cms_pagination-wrapper .w-pagination-next").addClass("is--ajax-load-btn").find(".blog-grid__lm-btn-text").html("Загрузить ещё");
      }
      if ($2(".blog-grid__card-title").length) {
        $2(".blog-grid__card-title").each(function() {
          $2(this).html(tp.execute($2(this).html()));
        });
        $2(".blog-grid__card-introtext").each(function() {
          $2(this).html(tp.execute($2(this).html()));
        });
      }
  ...
  $2(".fs-cms_pagination-wrapper .w-pagination-next").on("click", function() {
    setTimeout(function() {
      document.querySelectorAll(".article__preloader-wrapper").forEach((preloader) => {
        preloader.style.opacity = "0";
  ...
  $2('[data-remodal-id="consultation-vcs"]').remodal({
    closeOnOutsideClick: false
  });
  $2('[data-remodal-id="consultation-on-premise"]').remodal({
    closeOnOutsideClick: false
  });
  $2('[data-remodal-id="consultation"]').remodal({
    closeOnOutsideClick: false
  });
  $2('[data-remodal-id="pilot-modal"]').remodal({
    closeOnOutsideClick: false
  });
  const articleTOCWrapper = document.querySelector(".article__toc-wrapper");
  $2(document).on("opening", ".remodal", function() {
    ...
    let currentModal = $2(".remodal.remodal-is-opening"), modalId = "#" + currentModal.data("remodal-id"), iframeInModal = currentModal.find("iframe"), ScrollElement = currentModal.find(".popup__scroll-content");
  ...
  $2(document).on("closing", ".remodal", function() {
    let currentModal = $2(".remodal.remodal-is-closing"), iframeInModal = currentModal.find("iframe"), formInModal = currentModal.find("form"), formButton = formInModal.find(".button-submit");
    setTimeout(function() {
      $2('[data-action="form__button-close"]').removeClass("is--hidden");
      $2(".form__button-close").removeClass("is--hidden");
      $2(".remodal.is--success").removeClass("is--success");
      $2(".w-form-fail").hide();
      $2(".w-form-done").hide();
      if (formInModal.length) {
        formInModal.find(".input-icon").each(function() {
          $2(this).removeClass("display-none");
        });
        formButton.val(formButton.data("btn-default"));
        formInModal[0].reset();
        formInModal.show();
        formInModal.find("input").each(function() {
          $2(this).removeClass("input-error");
        });
      }
    }, 300);
  ...
  $2(document).on("closed", ".remodal", function() {
  ...
  function closeRemodal() {
    if ($2(".remodal.remodal-is-opened").length) {
      $2(".remodal.remodal-is-opened").find('[data-remodal-action="close"]').trigger("click");
    }
  }
  if (os === "Android") {
  ...
  $2("input").on("focusout focus", function() {
    setTimeout(function() {
  ...
  $2(".faq__trigger").on("click", function() {
    var toggle = $2(this), wrapper = toggle.parent(".faq__item");
    if (wrapper.hasClass("is--open")) {
      closeDropdown(wrapper);
    } else {
      openDropdown(wrapper);
    }
    closeDropdown($2(".faq__item.is--open").not(wrapper));
    if ($2(window).width() < 768 && !$2(this).hasClass("is--open")) {
      var headerHeight = $2(".w-nav").height() + 12, faqTrigger = $2(this);
      setTimeout(function() {
        $2("html, body").animate({
  ...
  $2(".faq__item").each(function() {
    closeDropdown($2(this));
  });
  $2(".faq__wrapper .faq__show-button").on("click", function() {
    $2(this).parent(".faq__wrapper").addClass("is--open");
  });
  $2(".faq__close-button").on("click", function() {
    $2(this).parent(".faq__wrapper").removeClass("is--open");
  });
  $2(".faq__wrapper").removeClass("is--open");
  function openDropdown(dropdown) {
    const dropdownContent = dropdown.find(".faq__resp-wrapper"), dropdownInnerContent = dropdown.find(".faq__resp");
    dropdownContent.css({
  ...
  copyFields == null ? void 0 : copyFields.forEach((copyField) => {
  ...
  if (copyPostLinkButton) {
    ...
    let copyPostLinkTimeout = setTimeout(function() {
    }, 0);
  ...
  if (isMobileDevice) {
    ...
    clipboard2 == null ? void 0 : clipboard2.on("success", function(e) {
      var _a2;
      showCopyNote();
      if ([
        "download",
        ...
        "download_cloud",
        "download_on-premise"
      ].indexOf(getPage()) === -1 && ((_a2 = e.trigger) == null ? void 0 : _a2.dataset.version) === "cloud") {
        sendEvent("25");
      }
    ...
    clipboard2 == null ? void 0 : clipboard2.on("error", function() {
      showCopyNote(
  ...
  function showCopyNote(text, error) {
    ...
    if (error) {
      ...
      messageElement.innerHTML = "Ссылка на скачивание Compass для&nbsp;компьютера скопирована";
    }
  ...
  (_k = document.querySelector(".event__message")) == null ? void 0 : _k.addEventListener("touchmove", function() {
    clearTimeout(closingMessageTimeout);
  ...
  $2(".w-dropdown-toggle").on("click", function(e) {
    if (e.which === 2) {
      e.preventDefault();
    }
  });
  if ($2(".blog-hero__filter").length) {
    $2(".blog-hero__filter-collection .blog-hero__filter-button").each(
      function() {
        $2(".blog-hero__filter-track").append($2(this));
      }
    );
    $2(".blog-hero__filter-collection").closest(".w-dyn-list").addClass("hidden");
  ...
  $2(".article__toc-button").on("click", function() {
    var tocList = $2(".article__toc-button").siblings(".article__toc-links");
  ...
  function readingTime(articleContent) {
    ...
    $2(".article__header-meta-time").text(result);
  }
  var validContent;
  if ($2(".article__content").length) {
    readingTime($2(".article__content"));
    $2(".article__content.w-richtext").each(function() {
      var content = $2(this).html();
    ...
    if ($2(".cta-op-banner-place").length) {
      $2(".cta-op-banner-place").append($2('[data-banner="cta-onpremise"]'));
      $2('[data-banner="cta-onpremise"]').removeClass("hidden");
    }
    if ($2(".cta-book-place").length) {
      $2(".cta-book-place").append($2(".article-book-cta--in-content"));
    }
  }
  if ($2(".blog-grid__wrapper--related-news").length) {
    let relatedItemsCount = $2(
      ".blog-grid__wrapper--related-news .blog-grid__card"
    ).length;
    if (relatedItemsCount > 0 && $2(".blog-grid__wrapper--related-news").data("items-count") !== relatedItemsCount) {
      $2(".blog-grid__wrapper--related-news").attr(
        "data-items-count",
        relatedItemsCount
      );
    } else if (relatedItemsCount === 0) {
      $2(".related-articles").hide();
    }
  }
  ...
  document.querySelectorAll("form").forEach((form) => {
    form.addEventListener("submit", function(e) {
      ...
      const url2 = currentHost + "www/getcompass/requestConsultation";
      ...
      if (formValidation(this)) {
        ...
        formData.set(
          "form_type",
          modalId === "#pilot-modal" ? "request_pilot_project" : "request_consultation"
        );
  ...
  function sendRequest(url2, form, formData) {
    ...
    const errorMessage = form.nextElementSibling.classList.contains("w-form-fail") ? form.nextElementSibling : form.nextElementSibling.nextElementSibling;
  ...
  function showErrorMessage(form, msg) {
    const button = form.querySelector('[type="submit"]');
    const errorMessage = Array.from(form.parentElement.children).find(
      (el2) => el2.classList.contains("w-form-fail")
    );
  ...
  window.addEventListener("resize", () => {
    ...
    if (window.innerWidth > 767) {
      ...
      $2(".article__toc-button").siblings(".article__toc-links").removeAttr("style").removeClass("is--open");
    } else {
      isMobile = true;
      body.classList.add("is--mobile-sm");
  ...
  window.addEventListener("scroll", () => {
    if (["partner", "on-premise"].indexOf(getPage()) + 1 && window.scrollY > getSize() * 47.13 || getPage() === "home" && window.scrollY > getSize() * 51.66 || getPage() === "download" && window.scrollY > getSize() * 25 || getPage() === "security" && window.scrollY > getSize() * 42.6 || getPage() === "vcs" && window.scrollY > getSize() * 44.7) {
      if ($2(window).width() < 768) {
        if (getPage() === "partner") {
          setTimeout(() => {
            $2(".menu-wrapper--is--mobile .cta__btn").removeClass("is--hidden");
          }, 200);
        } else {
          $2(".menu-wrapper--is--mobile .cta__dropdown").removeClass("is--hidden");
          $2(".menu-wrapper--is--mobile .cta__btn").removeClass("is--hidden");
        }
      }
    }
  ...
  const tabLinks = tabContainer == null ? void 0 : tabContainer.querySelectorAll(".w-tab-menu .w-tab-link");
  tabLinks == null ? void 0 : tabLinks.forEach((tabLink) => {
  ...
  class MenuDropdown {
    ...
    attachEventsHandlers() {
      ...
      window.addEventListener("mousedown", (e) => {
        ...
        if (!$2(e.target).closest(this.dropdown).length && window.innerWidth > 767) {
          this.close();
        }
      });
      window.addEventListener("resize", () => {
    ...
    closePlatformsDropdown() {
      $2(".w-dropdown").trigger("w-close");
      $2(".cta__dd-list-other-wrap").removeClass("is--open");
    }
  }
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    let scrollEventStart = false, scrollEvent50 = false, scrollEvent75 = false, scrollEvent100 = false;
    window.onscroll = function() {
      if ([
        ...
        if (!scrollEventStart && getScrollPercentage() > 0) {
          if ($2(".popup__video-iframe").find("iframe").length) {
            $2(".popup__video-iframe").find("iframe").each(function() {
              $2(this).attr("src", $2(this).data("src"));
            });
          }
        }
        if (!scrollEventStart && getScrollPercentage() > 0) {
  ...
  $2('a[href="/blog"], a[href*="/blog?"], a[href*="/blog/?"]').on(
    "click",
    function() {
      if (!(["blog", "post"].indexOf(getPage()) + 1)) {
        sendEvent("200");
      }
      if (getPage() === "post" && $2(this).hasClass("logo__container")) {
        sendEvent("214");
      }
    }
  );
  $2(".fs-cmsload_button").on("click", () => {
    sendEvent("256");
  });
  $2(".blog-grid__card-link").on("click", () => {
    if (getPage() === "blog") sendEvent("208");
  });
  $2('[data-banner="cta"] a').on("click", function() {
    sendEvent("221");
  });
  $2('a[href^="mailto"]').on("click", function() {
    if ($2(this).closest("footer").length) {
      if (["blog", "post"].indexOf(getPage()) + 1) {
        sendEvent("231");
      }
      sendEvent("6");
  ...
  $2('a[href^="tel"]').on("click", function() {
    if (["blog", "post"].indexOf(getPage()) + 1 && $2(this).closest("footer")) {
      sendEvent("232");
    } else if ($2(this).closest("footer").length) {
      sendEvent("95");
    }
    sendEvent("103");
  });
  $2(".cta__dropdown .w-dropdown-toggle").on("click", function() {
    if (!$2(this).closest(".price__block").length && !$2(this).closest(".navbar__wrapper").length && !$2(this).closest(".footer").length) {
      if (getPage() === "home") {
        sendEvent("50");
        _tmr.push({
          type: "reachGoal",
  ...
  $2(".price__block.is--start .w-dropdown-toggle").on("click", function() {
    sendEvent("65");
    _tmr.push({
      type: "reachGoal",
      id: 3381982,
  ...
  $2(".price__block.is--center .w-dropdown-toggle").on("click", function() {
    sendEvent("66");
    _tmr.push({
      type: "reachGoal",
      id: 3381982,
  ...
  $2(".price__block.is--corp .w-dropdown-toggle").on("click", function() {
    sendEvent("67");
  });
  $2("#carrot-messenger-collapsed-frame").on("click", function() {
    sendEvent("5");
  });
  $2(".ceo-link").on("click", function() {
    if ($2(this).closest("footer")) {
      if (["blog", "post"].indexOf(getPage()) + 1) {
        sendEvent("230");
      } else {
        sendEvent("94");
  ...
  $2(
    ...
    if ($2(this).closest("footer").length) {
      sendEvent("103");
    } else if ($2(this).closest(".remodal").length) {
      sendEvent("104");
    }
  });
  $2(".privacy-target").on("click", function() {
    sendEvent("7");
  });
  $2(".offer-target").on("click", function() {
    sendEvent("8");
  });
  $2(".reccurent-target").on("click", function() {
    sendEvent("31");
  });
  $2(".mediakit__link").on("click", function() {
    sendEvent("82");
  });
  $2('[href^="/mediakit"]').on("click", function() {
    if (["blog", "post"].indexOf(getPage()) + 1 && $2(this).closest("footer")) {
      sendEvent("229");
  ...
  $2('a[href*="github"]').on("click", function() {
    if (["on-premise", "download_on-premise"].includes(getPage())) {
      sendEvent("304");
    }
  });
  $2('a[href*="vc.ru/getcompass"]').on("click", function() {
    if (["blog", "post"].indexOf(getPage()) + 1) {
      if ($2(this).closest(".w-nav").length) {
        sendEvent("213");
      } else {
        sendEvent("228");
      }
  ...
  $2('a[href*="partner.getcompass.ru"]').on("click", function() {
    if (getPage() === "partner") {
      sendEvent("403");
    }
  });
  $2('a[href*="https://doc-onpremise.getcompass.ru/"]').on("click", () => {
    sendEvent("310");
  });
  $2('a[href^="/on-premise"]:not([href*="/on-premise/download"])').on(
    "click",
    function() {
      if (["blog", "post"].indexOf(getPage()) + 1) {
        if ($2(this).closest(".w-nav").length) {
          sendEvent("211");
        } else if ($2(this).closest("[data-cta-btns]").length) {
          sendEvent("217");
        } else if ($2(this).closest("footer").length) {
          sendEvent("233");
        }
  ...
  $2("[data-cta-btns] a").on("click", () => {
    if (["blog", "post"].indexOf(getPage()) + 1) {
      sendEvent("215");
    }
  });
  $2('.partner-page, a[href^="/partner"]').on("click", function() {
    if (["blog", "post"].indexOf(getPage()) + 1) {
      if ($2(this).closest(".w-nav").length) {
        sendEvent("212");
      } else if (getPage() === "post" && $2(this).closest('[data-banner="cta-partner"]').length) {
        sendEvent("224");
      } else if ($2(this).closest("[data-cta-btns]").length) {
        sendEvent("218");
      } else if ($2(this).closest("footer").length) {
  ...
  $2('[data-banner="cta-home"] a').on("click", () => {
    sendEvent("225");
  });
  const homeLinks = document.querySelectorAll(
    'a[href="/"], a[href^="/#"], a[href^="#"], a[href^="/?"]'
  );
  homeLinks == null ? void 0 : homeLinks.forEach((link) => {
