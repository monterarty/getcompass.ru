...
/* ---------------------*/
/* ---------------------*/
window.REMODAL_GLOBALS={NAMESPACE:"remodal",DEFAULTS:{hashTracking:!1}},function(t,a){"function"==typeof define&&define.amd?define(["jquery"],function(e){return a(t,e)}):"object"==typeof exports?a(t,require("jquery")):a(t,t.jQuery||t.Zepto)}(this,function(t,a){"use strict";function e(t){if(y&&"none"===t.css("animation-name")&&"none"===t.css("-webkit-animation-name")&&"none"===t.css("-moz-animation-name")&&"none"===t.css("-o-animation-name")&&"none"===t.css("-ms-animation-name"))return 0;var a,e,n,i,o=t.css("animation-duration")||t.css("-webkit-animation-duration")||t.css("-moz-animation-duration")||t.css("-o-animation-duration")||t.css("-ms-animation-duration")||"0s",s=t.css("animation-delay")||t.css("-webkit-animation-delay")||t.css("-moz-animation-delay")||t.css("-o-animation-delay")||t.css("-ms-animation-delay")||"0s",r=t.css("animation-iteration-count")||t.css("-webkit-animation-iteration-count")||t.css("-moz-animation-iteration-count")||t.css("-o-animation-iteration-count")||t.css("-ms-animation-iteration-count")||"1";for(o=o.split(", "),s=s.split(", "),r=r.split(", "),i=0,e=o.length,a=Number.NEGATIVE_INFINITY;i<e;i++)(n=parseFloat(o[i])*parseInt(r[i],10)+parseFloat(s[i]))>a&&(a=n);return a}function n(){if(a(document).height()<=a(window).height())return 0;var t,e,n=document.createElement("div"),i=document.createElement("div");return n.style.visibility="hidden",n.style.width="100px",document.body.appendChild(n),t=n.offsetWidth,n.style.overflow="scroll",i.style.width="100%",n.appendChild(i),e=i.offsetWidth,n.parentNode.removeChild(n),t-e}function i(){if(!N){var t,e,i=a("html"),o=d("is-locked");i.hasClass(o)&&(t=parseInt((e=a(document.body)).css("padding-right"),10)-n(),e.css("padding-right",t+"px"),i.removeClass(o))}}function o(t,a,e,n){var i=d("is",a),o=[d("is",O.CLOSING),d("is",O.OPENING),d("is",O.CLOSED),d("is",O.OPENED)].join(" ");t.$bg.removeClass(o).addClass(i),t.$overlay.removeClass(o).addClass(i),t.$wrapper.removeClass(o).addClass(i),t.$modal.removeClass(o).addClass(i),t.state=a,e||t.$modal.trigger({type:a,reason:n},[{reason:n}])}function s(t,n,i){var o=0,s=function(t){t.target===this&&o++},r=function(t){t.target===this&&0==--o&&(a.each(["$bg","$overlay","$wrapper","$modal"],function(t,a){i[a].off(g+" "+C)}),n())};a.each(["$bg","$overlay","$wrapper","$modal"],function(t,a){i[a].on(g,s).on(C,r)}),t(),0===e(i.$bg)&&0===e(i.$overlay)&&0===e(i.$wrapper)&&0===e(i.$modal)&&(a.each(["$bg","$overlay","$wrapper","$modal"],function(t,a){i[a].off(g+" "+C)}),n())}function r(t){t.state!==O.CLOSED&&(a.each(["$bg","$overlay","$wrapper","$modal"],function(a,e){t[e].off(g+" "+C)}),t.$bg.removeClass(t.settings.modifier),t.$overlay.removeClass(t.settings.modifier).hide(),t.$wrapper.hide(),i(),o(t,O.CLOSED,!0))}function d(){for(var t=h,a=0;a<arguments.length;++a)t+="-"+arguments[a];return t}function l(){var t,e,n=location.hash.replace("#","");if(n){try{e=a('[data-remodal-id="'+n+'"]')}catch(i){}e&&e.length&&(t=a[u].lookup[e.data(u)])&&t.settings.hashTracking&&t.open()}else p&&p.state===O.OPENED&&p.settings.hashTracking&&p.close()}function c(t,e){var n=a(document.body),i=this;i.settings=a.extend({},v,e),i.index=a[u].lookup.push(i)-1,i.state=O.CLOSED,i.$overlay=a("."+d("overlay")),null!==i.settings.appendTo&&i.settings.appendTo.length&&(n=a(i.settings.appendTo)),i.$overlay.length||(i.$overlay=a("<div>").addClass(d("overlay")+" "+d("is",O.CLOSED)).hide(),n.append(i.$overlay)),i.$bg=a("."+d("bg")).addClass(d("is",O.CLOSED)),i.$modal=t.addClass(h+" "+d("is-initialized")+" "+i.settings.modifier+" "+d("is",O.CLOSED)).attr("tabindex","-1"),i.$wrapper=a("<div>").addClass(d("wrapper")+" "+i.settings.modifier+" "+d("is",O.CLOSED)).hide().append(i.$modal),n.append(i.$wrapper),i.$wrapper.on("click."+h,'[data-remodal-action="close"]',function(t){t.preventDefault(),i.close()}),i.$wrapper.on("click."+h,'[data-remodal-action="cancel"]',function(t){t.preventDefault(),i.$modal.trigger(E.CANCELLATION),i.settings.closeOnCancel&&i.close(E.CANCELLATION)}),i.$wrapper.on("click."+h,'[data-remodal-action="confirm"]',function(t){t.preventDefault(),i.$modal.trigger(E.CONFIRMATION),i.settings.closeOnConfirm&&i.close(E.CONFIRMATION)}),i.$wrapper.on("mousedown."+h,function(t){a(t.target).hasClass(d("wrapper"))&&i.settings.closeOnOutsideClick&&i.close()})}var m,p,f,u="remodal",h=t.REMODAL_GLOBALS&&t.REMODAL_GLOBALS.NAMESPACE||u,g=a.map(["animationstart","webkitAnimationStart","MSAnimationStart","oAnimationStart"],function(t){return t+"."+h}).join(" "),C=a.map(["animationend","webkitAnimationEnd","MSAnimationEnd","oAnimationEnd"],function(t){return t+"."+h}).join(" "),v=a.extend({hashTracking:!0,closeOnConfirm:!0,closeOnCancel:!0,closeOnEscape:!0,closeOnOutsideClick:!0,modifier:"",appendTo:null},t.REMODAL_GLOBALS&&t.REMODAL_GLOBALS.DEFAULTS),O={CLOSING:"closing",CLOSED:"closed",OPENING:"opening",OPENED:"opened"},E={CONFIRMATION:"confirmation",CANCELLATION:"cancellation"},y=void 0!==(m=document.createElement("div").style).animationName||void 0!==m.WebkitAnimationName||void 0!==m.MozAnimationName||void 0!==m.msAnimationName||void 0!==m.OAnimationName,N=/iPad|iPhone|iPod/.test(navigator.platform);c.prototype.open=function(){var t,e=this;e.state!==O.OPENING&&e.state!==O.CLOSING&&((t=e.$modal.attr("data-remodal-id"))&&e.settings.hashTracking&&(f=a(window).scrollTop(),location.hash=t),p&&p!==e&&r(p),p=e,function t(){if(!N){var e,i,o=a("html"),s=d("is-locked");o.hasClass(s)||(e=parseInt((i=a(document.body)).css("padding-right"),10)+n(),i.css("padding-right",e+"px"),o.addClass(s))}}(),e.$bg.addClass(e.settings.modifier),e.$overlay.addClass(e.settings.modifier).show(),e.$wrapper.show().scrollTop(0),e.$modal.focus(),s(function(){o(e,O.OPENING)},function(){o(e,O.OPENED)},e))},c.prototype.close=function(t){var e=this;e.state!==O.OPENING&&e.state!==O.CLOSING&&e.state!==O.CLOSED&&(e.settings.hashTracking&&e.$modal.attr("data-remodal-id")===location.hash.substr(1)&&(location.hash="",a(window).scrollTop(f)),s(function(){o(e,O.CLOSING,!1,t)},function(){e.$bg.removeClass(e.settings.modifier),e.$overlay.removeClass(e.settings.modifier).hide(),e.$wrapper.hide(),i(),o(e,O.CLOSED,!1,t)},e))},c.prototype.getState=function(){return this.state},c.prototype.destroy=function(){var t,e=a[u].lookup;r(this),this.$wrapper.remove(),delete e[this.index],0===(t=a.grep(e,function(t){return!!t}).length)&&(this.$overlay.remove(),this.$bg.removeClass(d("is",O.CLOSING)+" "+d("is",O.OPENING)+" "+d("is",O.CLOSED)+" "+d("is",O.OPENED)))},a[u]={lookup:[]},a.fn[u]=function(t){var e,n;return this.each(function(i,o){null==(n=a(o)).data(u)?(e=new c(n,t),n.data(u,e.index),e.settings.hashTracking&&n.attr("data-remodal-id")===location.hash.substr(1)&&e.open()):e=a[u].lookup[n.data(u)]}),e},a(document).ready(function(){a(document).on("click","[data-remodal-target]",function(t){t.preventDefault();var e=a('[data-remodal-id="'+t.currentTarget.getAttribute("data-remodal-target")+'"]');a[u].lookup[e.data(u)].open()}),a(document).find("."+h).each(function(t,e){var n=a(e),i=n.data("remodal-options");i?("string"==typeof i||i instanceof String)&&(i=function t(a){var e,n,i,o,s={};for(e=(a=a.replace(/\s*:\s*/g,":").replace(/\s*,\s*/g,",")).split(","),o=0,n=e.length;o<n;o++)e[o]=e[o].split(":"),("string"==typeof(i=e[o][1])||i instanceof String)&&(i="true"===i||"false"!==i&&i),("string"==typeof i||i instanceof String)&&(i=isNaN(i)?i:+i),s[e[o][0]]=i;return s}(i)):i={},n[u](i)}),a(document).on("keydown."+h,function(t){p&&p.settings.closeOnEscape&&p.state===O.OPENED&&27===t.keyCode&&p.close()}),a(window).on("hashchange."+h,l)})});
/* ---------------------*/
/* ---------------------*/
