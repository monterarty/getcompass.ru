...
const body=document.body,getPage=()=>body.classList.contains("is--home-page")?"home":body.classList.contains("is--on-premise-page")?"on-premise":window.location.href.indexOf("download")+1>0?"download":void 0;function showOldBrowserMsg(){let e=document.querySelector(".navbar__old-msg");e&&(e.classList.add("is--display-block"),document.querySelector(".navbar__old-close").addEventListener("click",()=>{e.classList.remove("is--show")}),setTimeout(function(){e.classList.add("is--show")},100))}body.classList.add("is--js-success"),navigator.userAgent.indexOf(" UCBrowser/")>=0&&showOldBrowserMsg();var validContent,Detector=new oldBrowserDetector({c:87,f:73,o:70,s:{d:12}},function(){let e=oldBrowserDetector.getBrowser();"x"!=e.n&&0!=e.v&&showOldBrowserMsg()});switch(Detector.detect(),platform.name){case"Safari":switch(platform.os.family){case"iOS":platform.version.split(".")[0]<=13&&platform.os.version.split(".")[0]<=13&&showOldBrowserMsg();break;case"OS X":platform.version.split(".")[0]<=12&&(showOldBrowserMsg(),document.querySelector(".navbar__old-msg").textContent=platform.os.version.split(".")[0]+platform.name)}break;case"Chrome":case"Chrome Mobile":platform.version.split(".")[0]<=87&&showOldBrowserMsg();break;case"Opera":case"Firefox":platform.version.split(".")[0]<=73&&showOldBrowserMsg()}$(document).ready(function(){$(".w-webflow-badge").removeClass("w-webflow-badge").empty()});var os=platform.os.family;function getOS(){"use strict";var e=window.navigator.userAgent,t=window.navigator.userAgentData?window.navigator.userAgentData:window.navigator.platform||window.navigator.platform,o=null;return -1!==["Macintosh","MacIntel","MacPPC","Mac68K","macOS"].indexOf(t)?o="OS X":-1!==["iPhone","iPad","iPod"].indexOf(t)?o="iOS":-1!==["Win32","Win64","Windows","WinCE"].indexOf(t)?o="Windows":/Huawei/.test(e)?o="Huawei":/Android/.test(e)?o="Android":/Linux/.test(t)&&(o="Linux"),o}function iOS(){return["iPad Simulator","iPhone Simulator","iPod Simulator","iPad","iPhone","iPod"].includes(navigator.platform)||navigator.userAgent.includes("Mac")&&"ontouchend"in document}function isTouchDevice(){return"ontouchstart"in window||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0}if((null===os||"Android"==os)&&"OS X"==(os=getOS())&&iOS()&&(os="iOS"),isTouchDevice()&&body.classList.add("is--touch-device"),["iOS","Android","Huawei"].indexOf(os)+1){let e=document.querySelectorAll(".cta__dropdown");body.classList.add("is--touch-device"),document.querySelector(".page-wrapper").classList.remove("is--overflow-clip"),Array.prototype.forEach.call(e,e=>{e.classList.add("is--hidden-list"),e.addEventListener("click",()=>{switch(os){case"iOS":e.querySelector(".appstore").click();break;case"Android":e.querySelector(".playmarket").click();break;case"Huawei":e.querySelector(".huawei").click()}})})}switch(os){case"iOS":body.classList.add("is--ios");break;case"Android":case"Huawei":body.classList.add("is--android");break;case"Windows":body.classList.add("is--windows");break;case"Linux":body.classList.add("is--linux");break;case"OS X":body.classList.add("is--mac")}const instructionLinks={appstore:"/download/appstore",playmarket:"/download/playmarket",huawei:"/download/huawei",macintel:"/download/mac-os-intel",macapple:"/download/mac-os-m1-m2",windows:"/download/windows",linuxdeb:"/download/ubuntu",linuxtar:"/download/linux"},downloadLinks=document.querySelectorAll('.appstore, .playmarket, .huawei, .macintel, .macapple, .windows, .linuxdeb, .linuxtar, [data-platform="windows"]'),mobileClassNames=["appstore","playmarket","huawei"],mobileBodyClassNames=["is--ios","is--android","is--huawei"],url=new URL(location),urlParams=url.searchParams,startDownload=urlParams.get("start-download")||"",platformClass=urlParams.get("platform")||"",sourceID=urlParams.get("source_id")||"",utmTag=urlParams.get("utm_tag")||"";function openInstruction(e){e.addEventListener("click",t=>{var o="";for(platform in instructionLinks)e.classList.contains(platform)&&0>window.location.pathname.indexOf(instructionLinks[platform])&&(!mobileBodyClassNames.some(e=>document.body.classList.contains(e))||mobileClassNames.some(t=>e.classList.contains(t)))&&(t.preventDefault(),o=window.location.origin+instructionLinks[platform]+"/?start-download=true&platform="+platform,window.location.href=o);"download"==getPage()&&ym(ymetrikaID,"reachGoal","76")})}if(urlParams.delete("platform"),urlParams.delete("start-download"),window.history.pushState({},"",url.toString()),Array.prototype.forEach.call(downloadLinks,e=>{e.addEventListener("click",t=>{if("on-premise"!==getPage()&&"download"!==getPage()){for(platform in instructionLinks)if(e.classList.contains(platform))switch(console.log(platform),platform){case"appstore":ym(ymetrikaID,"reachGoal","12");break;case"huawei":ym(ymetrikaID,"reachGoal","13");break;case"playmarket":ym(ymetrikaID,"reachGoal","14");break;case"windows":ym(ymetrikaID,"reachGoal","15");break;case"macintel":case"macapple":ym(ymetrikaID,"reachGoal","16");break;case"linuxdeb":case"linuxtar":ym(ymetrikaID,"reachGoal","17")}}"home"==getPage()?(ym(ymetrikaID,"reachGoal","51"),_tmr.push({type:"reachGoal",id:3381982,goal:"click"})):"on-premise"==getPage()&&ym(ymetrikaID,"reachGoal","305")}),"on-premise"!==getPage()&&openInstruction(e),mobileClassNames.some(t=>e.classList.contains(t))||mobileBodyClassNames.some(e=>document.body.classList.contains(e))?!mobileClassNames.some(t=>e.classList.contains(t))&&mobileBodyClassNames.some(e=>document.body.classList.contains(e))&&(e.removeAttribute("download"),e.setAttribute("build-link",e.getAttribute("href")),e.setAttribute("href","#")):e.setAttribute("download","download")}),window.addEventListener("load",()=>{if(startDownload){let e=document.querySelector("."+platformClass)?.getAttribute("href");location.href=e}}),mobileBodyClassNames.some(e=>document.body.classList.contains(e))){var t=setTimeout(function(){},0);let o=new ClipboardJS("[build-link]",{text:function(e){return e.getAttribute("build-link")}});o.on("success",function(e){showCopyNote(),e.clearSelection()}),o.on("error",function(e){showCopyNote("Не получилось скопировать ссылку. Возможно, ваш&nbsp;браузер устарел.",!0)})}$(".cta__list-other-button").on("click",function(){$(this).parent().addClass("is--open")}),$(".cta__list-item:not(.cta__list-other-button)").on("click",function(){$(".w-dropdown").trigger("w-close")}),$(".cta__dropdown .w-dropdown-toggle").on("click",function(){$(".cta__dd-list-other-wrap").removeClass("is--open")});const setCenterCTAListArrow=e=>{let t=document.querySelectorAll(".cta__dd-list.is--has-arrow, .cta__dd-list.is--mobile-has-arrow");Array.prototype.forEach.call(t,e=>{e.style.setProperty("--popupLeft",0),e.style.setProperty("--arrowLeft",0);let t=e.getBoundingClientRect(),o=e.closest(".w-dropdown"),a=o.querySelector(".w-dropdown-list"),i=e.querySelector(".cta__dd-list-wrap"),n=o.querySelector(".cta__dd-center-arrow"),s=n.getBoundingClientRect();window.innerWidth<768?(0!=t.x&&a.style.setProperty("--popupLeft",`-${t.x}px`),a.style.setProperty("--arrowLeft",`${s.x-i.getBoundingClientRect().x+s.width/2}px`)):(a.style.removeProperty("left"),a.style.setProperty("--arrowLeft",`${s.x-t.x+s.width/2}px`))})},CTADropdowns=document.querySelectorAll(".w-dropdown");function addInputPhoneMask(){let e=document.querySelectorAll("input[data-tel-input]"),t=/\D/g,o=e=>e.value.replace(t,""),a=e=>{let a=e.target,i=o(a),n="",{selectionEnd:s,selectionStart:l}=a;if(!i){a.value="";return}if(a.value.length!==l&&e.data&&t.test(e.data)&&(a.value=i),["7","8","9"].indexOf(i[0])>-1){"9"===i[0]&&"iOS"==os&&(i=`7${i}`);let r=(i[0],"9"!==i[0])?"+7":"+";"9"===i[0]&&"iOS"!==os?n=`+${i.substring(0,16)}`:(n=`${r} `,i.length>1&&(n+=`(${i.substring(1,4)}`),i.length>=5&&(n+=`) ${i.substring(4,7)}`),i.length>=8&&(n+=`-${i.substring(7,9)}`),i.length>=10&&(n+=`-${i.substring(9,11)}`),i.length>=12&&(n=`+${i.substring(0,16)}`))}else n=`+${i.substring(0,16)}`;let d=c(i,n);a.value=n,a.setSelectionRange(d,d)},i=e=>{let t=e.target,o=t.value.replace(/\D/g,"");8===e.keyCode&&1===o.length&&(t.value="")},n=e=>{let a=e.target,i=o(a),n=e.clipboardData||window.Clipboard;if(n){let s=n.getData("Text");t.test(s)&&(a.value=i)}},s=e=>{let t=e.target;t.classList.contains("focus")||setTimeout(()=>{t.selectionStart=t.value.length},100),t.classList.add("focus")},l=e=>{let t=e.target;t.classList.remove("focus")},r=e=>{selectedNumberCount=Math.abs(e.target.value.slice(e.target.selectionStart,e.target.selectionEnd).replace(/\s/g,"").length),prevRawNumber=e.target.value.replace(/\D/g,""),prevNumberCaretPosition=e.target.value.slice(0,e.target.selectionStart).replace(/\D/g,"").length},c=(e,t)=>{let o=t.split(""),a=0,i=prevNumberCaretPosition+(e.length-prevRawNumber.length+selectedNumberCount),n;for(n=0;n<=o.length-1&&a!==i;n++)/\d/.test(o[n])&&++a;return n};e.forEach(e=>{e.addEventListener("input",a,!1),e.addEventListener("keydown",i),e.addEventListener("paste",n,!1),e.addEventListener("focus",s,!1),e.addEventListener("focusout",l,!1),e.addEventListener("beforeinput",r,!1)})}Array.prototype.forEach.call(CTADropdowns,e=>{let t=e.querySelector(".w-dropdown-toggle");t.addEventListener("click",o=>{t.classList.contains("w--open")||setCenterCTAListArrow(e)})}),addInputPhoneMask();const nameInputs=document.querySelectorAll("input[data-name-input]"),comandInputs=document.querySelectorAll("input[data-input-comand]");function removeErrorClassOnInput(e){e.addEventListener("input",()=>{e.classList.remove("input-error")}),e.addEventListener("focus",()=>{}),e.onblur=function(){let{value:t}=e,o=e.closest(".form-row").querySelector(".input-icon");!t&&o&&o.classList.remove("display-none")},e.onfocus=function(){let t=e.closest(".form-row").querySelector(".input-icon");t&&t.classList.add("display-none")}}function formValidation(e){let t=!0,o=e.querySelectorAll(".input");return o.forEach(e=>{let{value:o,dataset:a}=e;if(e.classList.remove("input-error"),e.hasAttribute("data-tel-input")){let i=/[^\d]/g;a.minLength&&o.replace(i,"").length<a.minLength&&(e.classList.add("input-error"),t=!1),a.maxLength&&o.replace(i,"").length>a.maxLength&&(e.classList.add("input-error"),t=!1),7==o.replace(i,"")[0]&&o.replace(i,"").length>11&&(e.classList.add("input-error"),t=!1)}e.hasAttribute("data-name-input")&&(/[^а-яА-ЯЁёІіЇїҐґЄєa-zA-ZẞßÄäÜüÖöÀàÈèÉéÌìÍíÎîÒòÓóÙùÚúÂâÊêÔôÛûËëÏïŸÿÇçÑñœ’`'.-\s]/g.test(o.trim())&&(e.classList.add("input-error"),t=!1),a.minLength&&o.trim().length<a.minLength&&(e.classList.add("input-error"),t=!1),a.maxLength&&o.trim().length>a.maxLength&&(e.classList.add("input-error"),t=!1)),"true"!==a.required||o||(e.classList.add("input-error"),t=!1)}),t}function checkValidationFormOnSubmit(e){let t=document.querySelector(e),o=t.querySelectorAll(".input"),a=e=>!!formValidation(t)||(t.querySelector(".w-button").value=t.querySelector(".w-button").getAttribute("data-btn-default"),!1);o.forEach(e=>{let t=e.getAttribute("data-required");t&&removeErrorClassOnInput(e)}),$(e).submit(a)}nameInputs.forEach(e=>{e.addEventListener("keypress",function(t){if(console.log(t),8!=t.keyCode&&46!=t.keyCode&&(e.value.length>49||t.key&&t.key.match(/[^а-яА-ЯЁёІіЇїҐґЄєa-zA-ZẞßÄäÜüÖöÀàÈèÉéÌìÍíÎîÒòÓóÙùÚúÂâÊêÔôÛûËëÏïŸÿÇçÑñœ’`'.-\s]/)))return t.preventDefault()}),e.addEventListener("input",function(t){"insertFromPaste"==t.inputType&&(e.value=e.value.replace(/[^а-яА-ЯЁёІіЇїҐґЄєa-zA-ZẞßÄäÜüÖöÀàÈèÉéÌìÍíÎîÒòÓóÙùÚúÂâÊêÔôÛûËëÏïŸÿÇçÑñœ’`'.-\s]/g,"").slice(0,50))})}),comandInputs.forEach(e=>{e.addEventListener("keypress",function(e){if(e.key&&e.key.match(/[^0-9]/))return e.preventDefault()}),e.addEventListener("input",function(t){e.value=e.value.replace(/[^0-9]/g,"").slice(0,12)})}),$("#wf-form-Consultation-Form").length&&checkValidationFormOnSubmit("#wf-form-Consultation-Form");var tp=new Typograf({locale:["ru","en-US"]}),article=document.querySelector(".article"),relatedArticles=document.querySelector(".related-articles");article&&(article.innerHTML=tp.execute(article.innerHTML),relatedArticles.innerHTML=tp.execute(relatedArticles.innerHTML)),window.fsAttributes=window.fsAttributes||[],window.fsAttributes.push(["cmsload",e=>{$(".fs-cms_pagination-wrapper").length&&$(".fs-cms_pagination-wrapper .w-pagination-next").addClass("is--ajax-load-btn").find(".blog-grid__lm-btn-text").html("Загрузить ещё"),$(".blog-grid__card-title").length&&($(".blog-grid__card-title").each(function(){$(this).html(tp.execute($(this).html()))}),$(".blog-grid__card-introtext").each(function(){$(this).html(tp.execute($(this).html()))}));let[t]=e;t.on("renderitems",e=>{$(".blog-grid__card-title").length&&($(".blog-grid__card-title").each(function(){$(this).html(tp.execute($(this).html()))}),$(".blog-grid__card-introtext").each(function(){$(this).html(tp.execute($(this).html()))}),document.querySelectorAll(".article__preloader-wrapper").forEach(e=>{setTimeout(function(){e.style.opacity="0",e.addEventListener("transitionend",()=>e.remove())},500)}))})},]),$(".form__success-button, .form__button-close").on("click",function(){var e=$(this);setTimeout(function(){e.closest(".remodal").find(".w-form-done").hide(),e.closest(".remodal").find("form").show()},300)});var scrollDistance=0,scrollBarWidth=window.innerWidth-document.body.clientWidth;const bodyScrollControls={disable(){body.style.top=`-${window.scrollY}px`,scrollDistance=window.scrollY,body.style.position="fixed",body.style.left=0,body.style.right=0,document.body.style.marginRight=`${scrollBarWidth}px`,document.querySelector(".w-nav").style.right=`${scrollBarWidth}px`,document.querySelector(".cookie").style.marhinRight=`${scrollBarWidth}px`,document.getElementById("carrotquest-messenger-collapsed-container")&&document.getElementById("carrotquest-messenger-collapsed-container").style.setProperty("right",`${scrollBarWidth}px`,"important"),document.body.style.paddingRight=null,document.body.style.overflowY="hidden"},enable(){body.removeAttribute("style"),window.scrollTo(0,scrollDistance),document.body.style.marginRight=null,document.body.style.paddingRight=null,document.querySelector(".cookie").style.marhinRight=0,document.querySelector(".w-nav").style.right=0,document.getElementById("carrotquest-messenger-collapsed-container")&&(document.getElementById("carrotquest-messenger-collapsed-container").style.right=0),document.body.style.overflowY=null}};function closeRemodal(){$(".remodal.remodal-is-opened").length&&$(".remodal.remodal-is-opened").find('[data-remodal-action="close"]').trigger("click")}function openDropdown(e){var t=e.find(".faq__resp-wrapper"),o=e.find(".faq__resp");t.css({height:t.find("div").innerHeight()}),o.css({opacity:1}),e.addClass("is--open")}function closeDropdown(e){var t=e.find(".faq__resp-wrapper"),o=e.find(".faq__resp");t.css({height:0}),o.css({opacity:0}),e.removeClass("is--open")}$('[data-remodal-id="consultation"]').remodal({closeOnOutsideClick:!1}),$(document).on("opening",".remodal",function(e){bodyScrollControls.disable(),$("html").addClass("remodal-is-locked");let t=$(".remodal.remodal-is-opening"),o="#"+t.data("remodal-id"),a=t.find("iframe"),i=(t.find("form"),t.find(".popup__scroll-content"));["#video-mac-intel","#video-mac-apple","#video-linux-deb-standart","#video-linux-deb-terminal","#video-linux-tar","#video-windows","#video-czech","#video-detailing-group","#video-daily","#video-good-people"].includes(o)?$("html").addClass("is--black-overlay is--center-modal is---video-overlay"):$("html").addClass("is--white-overlay is--center-modal"),analyticsModal(o),i.animate({scrollTop:0},0),a.length&&void 0!==window.Vimeo&&new Vimeo.Player(a[0]).play()}),$(document).on("closing",".remodal",function(e){let t=$(".remodal.remodal-is-closing"),o=t.find("iframe"),a=t.find("form"),i=a.find(".button-submit");setTimeout(function(){$(".form__button-close").removeClass("is--hidden"),$(".remodal.is--success").removeClass("is--success"),$(".w-form-fail").hide(),$(".w-form-done").hide(),a.length&&(a.find(".input-icon").each(function(){$(this).removeClass("display-none")}),i.val(i.data("btn-default")),a[0].reset(),a.show(),a.find("input").each(function(){$(this).removeClass("input-error")}))},300),o.length&&(o.attr("src",""),o.attr("src",o.data("src")))}),$(document).on("closed",".remodal",function(e){bodyScrollControls.enable(),$("html").removeClass("is--black-overlay is--white-overlay remodal-is-locked is--center-modal is---video-overlay")}),window.addEventListener("popstate",e=>{closeRemodal()}),document.onkeydown=function(e){27==e.keyCode&&closeRemodal()},$("input").on("focusout focus",function(){setTimeout(function(){$("html").hasClass("remodal-is-locked")&&($("html").removeClass("remodal-is-locked"),$("html").addClass("remodal-is-locked"))},300)}),$(".faq__trigger").on("click",function(){var e=$(this).parent(".faq__item");if(e.hasClass("is--open")?closeDropdown(e):openDropdown(e),closeDropdown($(".faq__item.is--open").not(e)),768>$(window).width()&&!$(this).hasClass("is--open")){var t=$(".w-nav").height()+12,o=$(this);setTimeout(function(){$("html, body").animate({scrollTop:o.offset().top-t})},500)}}),$(".faq__item").each(function(){closeDropdown($(this))}),$(".faq__show-button").on("click",function(){$(this).parent(".faq__wrapper").addClass("is--open")}),$(".faq__close-button").on("click",function(){$(this).parent(".faq__wrapper").removeClass("is--open")}),$(".faq__wrapper").removeClass("is--open");const copyFields=document.querySelectorAll("[clipboard-field]");Array.prototype.forEach.call(copyFields,e=>{let t=e.querySelector("[clipboard-btn]"),o=e.querySelector("[clipboard-tooltip]"),a=e.querySelector("[clipboard-text]").textContent,i=new ClipboardJS(t,{text:function(e){return a}});i.on("success",function(e){o.textContent="Скопировано",t.classList.add("is--done"),setTimeout(()=>{t.classList.remove("is--done")},2e3),e.clearSelection()}),i.on("error",function(e){o.textContent="Ошибка!",t.classList.add("is--fail"),setTimeout(()=>{t.classList.remove("is--fail")},2e3),e.clearSelection()})}),$(".article__social-share-link--copy").css("display","inline-block");var copyPostLinkTimeout=setTimeout(function(){},0),copyPostLink=new ClipboardJS(".article__social-share-link--copy",{text:function(e){return window.location.href}});function showCopyNote(e,o){clearTimeout(t),""!=e&&$(".event__message").html(e),o?$(".event__message").addClass("is--error"):($(".event__message").removeClass("is--error"),$(".event__message").html("Ссылка на скачивание Compass для&nbsp;компьютера скопирована")),$(".event__message").addClass("is--display-block"),setTimeout(function(){$(".event__message").addClass("is--visible")},300),t=setTimeout(function(){$(".event__message").removeClass("is--visible"),setTimeout(function(){$(".event__message").removeClass("is--display-block")},300)},4e3)}function tabsSwipeHandler(e,t){let o=e.closest(".w-tabs").find(".w-tab-menu"),a=o.find(".w--current").next("a"),i=o.find(".w--current").prev("a");"left"==t&&768>$(window).width()?a.length<1?(o.addClass("scroll-bounce-left"),setTimeout(function(){o.removeClass("scroll-bounce-left")},800)):a.click():"right"==t&&768>$(window).width()&&(i.length<1?(o.addClass("scroll-bounce-right"),setTimeout(function(){o.removeClass("scroll-bounce-right")},800)):i.click())}copyPostLink.on("success",function(e){clearTimeout(copyPostLinkTimeout);var t=$(e.trigger);t.addClass("is--copy-done"),copyPostLinkTimeout=setTimeout(function(){t.removeClass("is--copy-done")},2e3),e.clearSelection()}),copyPostLink.on("error",function(e){clearTimeout(copyPostLinkTimeout);var t=$(e.trigger);t.addClass("is--copy-fail"),copyPostLinkTimeout=setTimeout(function(){t.removeClass("is--copy-fail")},2e3)}),$(".event__message").on("touchmove",function(){clearTimeout(t),$(".event__message").removeClass("is--visible"),setTimeout(function(){$(".event__message").removeClass("is--display-block")},300)}),$(".target__tab-menu-block .w-tab-link.w--current").each(function(){$(this).find(".tab-menu__description").height($(this).find(".tab-menu__description div").outerHeight())}),$(".w-tab-link").on("click",function(e){2==e.which&&e.preventDefault()}),$(".target__section .w-tab-content").swipe({swipeStatus:function(e,t,o,a,i,n,s,l){"end"==t&&o==l&&("left"==o||"right"==o)&&tabsSwipeHandler($(this),o)},allowPageScroll:"vertical"});var allSliders=[];768>$(window).width()&&($(".hero__slider").length||$(".target__section .w-tabs").length||$(".blog-hero__filter-button").length>2)&&sliderInit();var blogCategorySlider=!1;function sliderInit(){if($(".target__section .w-tabs").length>0&&$(".target__section .w-tabs").each(function(e){let t=$(this);t.addClass("swiper-container"),t.find(".w-tab-menu").addClass("swiper-wrapper"),t.find(".w-tab-link:last").addClass("is--last"),t.find(".w-tab-link").each(function(){$(this).addClass("swiper-slide")}),allSliders[e]=new Swiper(t[0],{slidesPerView:"auto",spaceBetween:0,speed:400}),allSliders[e].on("transitionStart",function(){$(allSliders[e].slidesEl).find(".w-tab-link").eq(allSliders[e].snapIndex).trigger("click")})}),$(".blog-hero__filter").length){$(".blog-hero__filter").addClass("swiper-container"),$(".blog-hero__filter-track").addClass("swiper-wrapper"),$(".blog-hero__filter-collection .blog-hero__filter-button").each(function(){$(".blog-hero__filter-track").append($(this))}),$(".blog-hero__filter .w-dyn-list").hide(),$(".blog-hero__filter-button").each(function(){$(this).addClass("swiper-slide")});var e=$(".blog-hero__filter-button").index($(".blog-hero__filter-button.w--current")),t=new Swiper(".blog-hero__filter",{slidesPerView:"auto",spaceBetween:0,speed:400});e>2&&t.slideTo(e)}}function sliderDisable(){allSliders.length>1&&allSliders.forEach(e=>{e.destroy(!0,!0)}),$(".target__section .w-tabs").each(function(e){let t=$(this);t.removeClass("swiper-container"),t.find(".w-tab-menu").removeClass("swiper-wrapper").css({transform:"translate3d(0px, 0, 0)"}),t.find(".w-tab-link:last").removeClass("is--last"),t.find(".w-tab-link").each(function(){$(this).removeClass("swiper-slide")})}),$(".blog-hero__filter").length&&(blogCategorySlider&&blogCategorySlider.destroy(!0,!0),$(".blog-hero__filter").removeClass("swiper-container"),$(".blog-hero__filter-track").removeClass("swiper-wrapper"),$(".blog-hero__filter-button").each(function(){$(this).removeClass("swiper-slide")}))}function removeAnchorFormURL(){setTimeout(()=>{window.history.replaceState({},"",window.location.href.split("#")[0])},100)}function readingTime(e){let t=`Время прочтения: ${Math.ceil(e.text().trim().split(/\s+/).length/225)} мин.`;$(".article__header-meta-time").text(t)}if($(".target__tab-menu-block .w-tab-link").on("click",function(){let e=$(this),t=$(this).closest(".w-tabs"),o=e.find(".tab-menu__description"),a=e.closest(".w-tabs").find(".w-tab-content"),i=e.parent(".target__tab-menu-block").find("a").index(e),n=$(".w-tabs").index(t);$(window).width()>767?(o.css({height:o.find("div").outerHeight(),opacity:1}),e.siblings(".w--current").find(".tab-menu__description").css({height:0,opacity:0})):(i!=allSliders[n].activeIndex&&allSliders[n].slideTo(i),a.css({height:a.find(".w-tab-pane").eq(i).outerHeight()}))}),window.location.hash&&$(window.location.hash).length&&($("html,body").animate({scrollTop:$(window.location.hash).offset().top},800),removeAnchorFormURL()),history.scrollRestoration="manual",removeAnchorFormURL(),$('a[href^="#"]').on("click",function(){removeAnchorFormURL()}),$(".article__toc-button").on("click",function(){var e=$(".article__toc-button").siblings(".article__toc-links");$(this).hasClass("is--open")?e.css({height:0,opacity:0}):e.css({height:e.find("div").outerHeight(),opacity:1}),$(this).toggleClass("is--open")}),$(".article__content").length&&(readingTime($(".article__content")),$(".article__content.w-richtext").each(function(){var e=$(this).html();(validContent=(e.match(/{{mobile/g)||[]).length==(e.match(/{{\/mobile/g)||[]).length&&(e.match(/{{pc/g)||[]).length==(e.match(/{{\/pc/g)||[]).length?1:0)&&$(this).html(e.replace(/<li>{{isTrue}}/g,'<li class="is--true">').replace(/<p>{{mobile}}<\/p>/g,'<div class="article__mobile-content">').replace(/<p>{{pc}}<\/p>/g,'<div class="article__desctop-content">').replace(/<p>{{\/pc}}<\/p>/g,"</div>").replace(/<p>{{\/mobile}}<\/p>/g,"</div>").replace(/<p>{{cta_banner}}<\/p>/g,'<div class="cta-banner-place"></div>').replace(/<p>{{cta_book}}<\/p>/g,'<div class="cta-book-place"></div>')),$(this).find("a").each(function(){$(this).text().indexOf("{{")+1&&($(this).addClass("article__cta-button"),$(this).parent().addClass("article__cta-button-wrap"),$(this).html(`<div>${$(this).text().replace(/[{}]+/g,"")}</div><div class="article-cta__button-icon w-embed"><svg width="100%" height="100%" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.99254 9.93963L5.03374 8.99148L8.36293 5.66229H0V4.27734H8.36293L5.03374 0.953481L5.99254 0L10.9624 4.96982L5.99254 9.93963Z" fill="currentColor"></path></svg></div>`))})}),$(".cta-banner-place").length&&($(".article-cta--in-content .article-cta__title.w-dyn-bind-empty").text("Знакомая ситуация?"),$(".article-cta--in-content .article-cta__subtitle.w-dyn-bind-empty").html("Попробуйте мессенджер, который приведёт в&nbsp;порядок рабочее общение."),$(".cta-banner-place").append($(".article-cta--in-content")),$(".article-cta--in-content").css("display","flex")),$(".cta-book-place").length&&$(".cta-book-place").append($(".article-book-cta--in-content"))),$(".blog-grid__wrapper--related-news").length){let a=$(".blog-grid__wrapper--related-news .blog-grid__card").length;a>0&&$(".blog-grid__wrapper--related-news").data("items-count")!=a?$(".blog-grid__wrapper--related-news").attr("data-items-count",a):0==a&&$(".related-articles").hide()}var vkLink=document.querySelectorAll(".article__social-share-link--vk"),tgLink=document.querySelectorAll(".article__social-share-link--tg");function formToJson(e){var t=e.serializeArray(),o={};return $.each(t,function(){o[this.name]=this.value||0}),JSON.stringify(o)}function getSanitizedFormName(e){return e.replace(/\+/g," ")}function getScrollPercentage(){let e=window.pageYOffset||document.documentElement.scrollTop,t=window.innerHeight||document.documentElement.clientHeight||document.body.clientHeight;return e/(Math.max(document.body.scrollHeight,document.body.offsetHeight,document.body.clientHeight,document.documentElement.scrollHeight,document.documentElement.offsetHeight,document.documentElement.clientHeight)-t)*100}function analyticsModal(e){switch(e){case"#consultation":"on-premise"==getPage()?ym(ymetrikaID,"reachGoal","301"):ym(ymetrikaID,"reachGoal","9");break;case"#video-mac-intel":ym(ymetrikaID,"reachGoal","71");break;case"#video-mac-apple":ym(ymetrikaID,"reachGoal","72");break;case"#video-linux-deb-standart":case"#video-linux-deb-terminal":ym(ymetrikaID,"reachGoal","73");break;case"#video-linux-tar":ym(ymetrikaID,"reachGoal","74");break;case"#video-windows":ym(ymetrikaID,"reachGoal","75");break;case"#video-czech":ym(ymetrikaID,"reachGoal","18");break;case"#video-detailing-group":ym(ymetrikaID,"reachGoal","19");break;case"#video-daily":ym(ymetrikaID,"reachGoal","20");break;case"#video-good-people":ym(ymetrikaID,"reachGoal","21")}}vkLink.length&&vkLink.forEach(e=>{e.addEventListener("click",()=>{window.open("https://vk.com/share.php?url="+window.location.href)})}),tgLink.length&&tgLink.forEach(e=>{e.addEventListener("click",()=>{window.open("https://t.me/share/url?url="+encodeURIComponent(window.location.href)+"&text="+encodeURIComponent(document.title))})}),$("form").on("submit",function(e){var t=$(this),o=new FormData($(this)[0]),a=`${window.location.protocol}//${window.location.host}/`,i=t.find('[type="submit"]'),n=t.siblings(".w-form-done"),s=t.siblings(".w-form-fail");return!!formValidation(t[0])&&(""==o.get("team_size")&&o.set("team_size",0),o.set("source_id",sourceID),o.set("utm_tag",utmTag),i.val(i.data("wait")),$.ajax({url:a+"www/getcompass/requestConsultation",type:"POST",dataType:"text",data:o,contentType:!1,processData:!1,statusCode:{423:function(e){s.find("div").html("Превышенно количество отправленных заявок. Пожалуйста, попробуйте повторить через 2&nbsp;часа.")}},success:function(e){let o="ok"==JSON.parse(e).status;o&&(i.val(i.data("btn-default")),n.show(),s.hide(),t.hide(),"on-premise"==getPage()?ym(ymetrikaID,"reachGoal","302"):(ym(ymetrikaID,"reachGoal","10"),_tmr.push({type:"reachGoal",id:3381982,goal:"Demo"})),t.closest(".remodal").addClass("is--success").removeClass("is--no-radius"),$("html").hasClass("remodal-is-locked")&&($("html").removeClass("is--white-overlay"),$("html").removeClass("is--disable-bg-close")))},error:function(e,o,a){s.find("div").html("Возникла ошибка при отправке формы, проверьте интернет-соединение или попробуйте позже."),i.val(i.data("btn-default")),s.show(),setTimeout(function(){s.hide()},3e3),t.show(),console.log(e,o,a)}}),!1)}),window.addEventListener("resize",e=>{setCenterCTAListArrow(),$(window).width()>767?($(".w-tab-content").each(function(){$(this).removeAttr("style")}),$(".article__toc-button").siblings(".article__toc-links").removeAttr("style").removeClass("is--open"),sliderDisable()):(!allSliders[0]||allSliders[0].destroyed)&&sliderInit(),setTimeout(function(){$(".target__tab-menu-block .w-tab-link.w--current").each(function(){$(this).trigger("click")})},200)}),window.addEventListener("scroll",e=>{$(".business__section").length&&$(window).scrollTop()+$(window).height()>=$(".business__section").offset().top&&(768>$(window).width()&&($(".menu-wrapper--is--mobile .cta__dropdown").removeClass("is--hidden"),$(".menu-wrapper--is--mobile .cta__btn").removeClass("is--hidden")),$(".navbar__logo-text").addClass("is--visible"))}),document.addEventListener("DOMContentLoaded",function(){setCenterCTAListArrow(),setTimeout(function(){"home"==getPage()&&ym(ymetrikaID,"reachGoal","4")},6e4);var e=!1,t=!1,o=!1;window.onscroll=function(){$(".w-nav-button").hasClass("w--open")&&$(".w-nav-button").trigger("click"),("home"==getPage()||"download"==getPage())&&(getScrollPercentage()>10&&$(".popup__video-iframe").find("iframe").length&&$(".popup__video-iframe").find("iframe").each(function(){$(this).attr("src",$(this).data("src"))}),!e&&getScrollPercentage()>50&&("home"==getPage()&&ym(ymetrikaID,"reachGoal","1"),e=!0),!t&&getScrollPercentage()>75&&("home"==getPage()&&ym(ymetrikaID,"reachGoal","2"),t=!0),!o&&getScrollPercentage()>95&&("home"==getPage()&&ym(ymetrikaID,"reachGoal","3"),o=!0))}}),$(".menu__navlink--blog").on("click",function(){ym(ymetrikaID,"reachGoal","61")}),$(".navbar__button--blog").on("click",function(){ym(ymetrikaID,"reachGoal","62")}),$(".article-cta").on("click",function(){ym(ymetrikaID,"reachGoal","63")}),$(".footer__item-download.appstore, .footer__item-download.playmarket, .footer__item-download.huawei, .blog-footer__link--store").on("click",function(){ym(ymetrikaID,"reachGoal","23")}),$(".footer__item-contact-link.is--email-link").on("click",function(){ym(ymetrikaID,"reachGoal","6")}),$(".navbar__wrapper .w-dropdown-toggle").on("click",function(){ym(ymetrikaID,"reachGoal","11"),_tmr.push({type:"reachGoal",id:3381982,goal:"besplatno"})}),$(".cta__dropdown .w-dropdown-toggle").on("click",function(){$(this).closest(".price__block").length||(ym(ymetrikaID,"reachGoal","50"),_tmr.push({type:"reachGoal",id:3381982,goal:"besplatno"}))}),$(".price__block.is--start .w-dropdown-toggle").on("click",function(){ym(ymetrikaID,"reachGoal","65"),_tmr.push({type:"reachGoal",id:3381982,goal:"besplatno"})}),$(".price__block.is--center .w-dropdown-toggle").on("click",function(){ym(ymetrikaID,"reachGoal","66"),_tmr.push({type:"reachGoal",id:3381982,goal:"besplatno"})}),$(".price__block.is--corp .w-dropdown-toggle").on("click",function(){ym(ymetrikaID,"reachGoal","67")}),$(".logo-vendor__item").on("click",function(){$(this).hasClass("w-dropdown-toggle")||ym(ymetrikaID,"reachGoal","23")}),$("#carrot-messenger-collapsed-frame").on("click",function(){ym(ymetrikaID,"reachGoal","5")}),$(".privacy-target").on("click",function(){ym(ymetrikaID,"reachGoal","7")}),$(".offer-target").on("click",function(){ym(ymetrikaID,"reachGoal","8")}),$(".reccurent-target").on("click",function(){ym(ymetrikaID,"reachGoal","31")}),$(".mediakit__link").on("click",function(){ym(ymetrikaID,"reachGoal","82")}),window.location.href.indexOf("mediakit")+1>0&&ym(ymetrikaID,"reachGoal","81"),$('a[href*="github"]').on("click",function(){"on-premise"==getPage()&&ym(ymetrikaID,"reachGoal","304")}),$('a[href*="on-premise"]').on("click",function(){"home"==getPage()&&ym(ymetrikaID,"reachGoal","300")}),$('a[href="/"]').on("click",function(){"on-premise"==getPage()&&ym(ymetrikaID,"reachGoal","300")});
